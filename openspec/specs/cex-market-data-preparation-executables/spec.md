# cex-market-data-preparation-executables Specification

## Purpose
Define the standalone CEX-owned preparation commands, exact qualified archive
export contract, and immutable published-release identity consumed by Maker.
