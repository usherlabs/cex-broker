...
- [ ] 8.1 Complete every reopened pre-freeze task in sections 9 and 10, and have Maker prove deterministic clean-extraction invocation of both role-neutral preparation-library operations plus ownership of the cross-stage and cross-pair state machine without live credentials. Do not reserve a version while this gate is open.
