...
**Reason**: The profile was built around the deleted CEX canonical Parquet exporter and incorrectly couples CEX conformance to Maker reconstruction, policy, and FIET-907 loader behavior.

**Migration**: Delete `native_replay`, its `maker_replay` sidecar branch, reference export, Parquet descriptors, replay validator, FIET-907 assertion, and combined Proof A/B gate. Keep FIET-907 replay and policy tests entirely in Maker.
