...
import type {
	CexServiceClient as _cexBroker_CexServiceClient,
	CexServiceDefinition as _cexBroker_CexServiceDefinition,
} from "./cexBroker/CexService";
...
export interface ProtoGrpcType {
	cexBroker: {
		...
		CexService: SubtypeConstructor<
			typeof grpc.Client,
			_cexBroker_CexServiceClient
